...
if (signupForm) signupForm.addEventListener("submit", (e)=>{
    ...
    (0, _login.signup)(name, email, password, passwordConfirm, apiUrl);
});
...
if (loginForm) loginForm.addEventListener("submit", (e)=>{
    ...
    const email = document.getElementById("email").value;
    const password = document.getElementById("password").value;
    (0, _login.login)(email, password, apiUrl);
});
...
if (userDataForm) userDataForm.addEventListener("submit", (e)=>{
    ...
    (0, _updateSetting.updateSettings)(form, "data", apiUrl);
});
...
if (bookBtn) bookBtn.addEventListener("click", (e)=>{
    ...
    (0, _stripe.bookTour)(tourId, apiUrl);
});
...
if (reviewForm) reviewForm.addEventListener("submit", async (e)=>{
    ...
    await (0, _review.reviewAndRating)(rating, review, user, tour, apiUrl);
    document.getElementById("review").value = "";
    document.getElementById("rating").value = "";
});

},{"@babel/polyfill":"dTCHC","./login":"7yHem","./leaflet":"xvuTT","./updateSetting":"6GcZk","./stripe":"10tSC","./review":"9Gbth"}],"dTCHC":[function(require,module,exports) {
"use strict";
...
const login = async (email, password, apiUrl)=>{
    try {
        ...
        (0, _alerts.showAlert)("err", error.response.data.message);
    }
};
const logout = async ()=>{
    try {
...
const signup = async (name, email, password, passwordConfirm, apiUrl)=>{
    try {
        const res = await (0, _axiosDefault.default)({
            method: "POST",
...
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const updateSettings = async (data, type, apiUrl)=>{
    try {
        const url = type === "password" ? `${apiUrl}/api/v1/users/updatePassword` : `${apiUrl}/api/v1/users/updateMe`;
        const res = await (0, _axiosDefault.default)({
            method: "PATCH",
            url,
            data
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alerts = require("./alerts");
const bookTour = async (tourId, apiUrl)=>{
    const stripe = Stripe("pk_test_oKhSR5nslBRnBZpjO6KuzZeX");
    try {
        // 1) Get checkout session from API
        const session = await (0, _axiosDefault.default)(`${apiUrl}/api/v1/bookings/checkout-session/${tourId}`);
        // console.log(session);
...
/* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "reviewAndRating", ()=>reviewAndRating);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alerts = require("./alerts");
const reviewAndRating = async (rating, review, user, tour, apiUrl)=>{
    try {
        const res = await (0, _axiosDefault.default)({
            method: "POST",
        ...
        if (res.data.status === "success") (0, _alerts.showAlert)("success", "Review was successfully!");
    } catch (error) {
        (0, _alerts.showAlert)("err", "You can only write one review for every tours");
    }
};
